              ...
              <tbody>
                <tr>
                  ...
                  >
                    ...
                    crédito hasta por la suma de {pagareWords} PESOS MCTE. ($
                ...
                <tr>
                  ...
                  >
                    ...
                    cuyas fechas de vencimiento sean posteriores al día{' '}
                    {billData[0].FECHA_PAGARE}, pero advirtiendo que la caución
                    prendaria se extiende no solamente a la suma debida, sino
                    también a los intereses de la obligación u obligaciones
                    contraídos, los cuales quedarán garantizados igualmente por
                    la prenda. QUINTA: Los créditos respectivos pueden constar
                    en cualquier clase de títulos valores en los que firme EL
                    DEUDOR como girador, aceptante, endosante, suscriptor u
                    ordenante, directa o indirectamente, individual o
                    conjuntamente, con otras firmas o en cualquier otro
                    documento proveniente del DEUDOR a favor de EL ACREEDOR.
                    SEXTA: Para los efectos legales correspondientes se toma
                    como fecha de vencimiento de la obligación asegurada por
                    medio de la prenda aquí constituida, el día de su
                    vencimiento, esto es el {billData[0].FVTO_PAG}. Sin
                    perjuicio de lo anterior,la obligación global se vencerá
                    anticipadamente cuando quiera que se presente las siguientes
                    eventualidades:A.- Por el simple retraso en el pago de uno o
                    más instalamentos por pagar del título valor o documento
                    otorgado por EL DEUDOR a favor de EL ACREEDOR. En este caso,
                    bastará EL ACREEDOR presentar ante el respectivo Juez, este
                    documento de prenda y otros títulos valores o documentos en
                    que consten las deudas correspondientes. B.- Por no poner a
                    disposición de EL ACREEDOR el vehículo dado en prenda dentro
                    de las 24 horas siguientes a la comunicación fehaciente,
                    dirigida a la residencia registrada ante EL ACREEDOR por EL
                    DEUDOR, en la cual solicita la presentación del automotor
                    pignorado para su inspección. Y C.- Por incumplimiento de
                    cualquiera de las obligaciones contraídas en el presente
                    contrato.<br></br> Todo lo anterior sin menoscabo de las
                    acciones civiles y penales a que tenga derecho EL ACREEDOR.
                    PARÁGRAFO: No obstante el vencimiento establecido para la
                    obligación asegurada, la Prenda conservará su vigencia
                    mientras existan obligaciones pendientes de pago, sean
                    directas o indirectas a cargo de EL DEUDOR y a favor de EL
                    ACREEDOR y mientras esta no cancele en forma expresa y
                    escrita el gravamen prendario que por medio de este contrato
                    se constituye. SÉPTIMA: Son obligaciones especiales de EL
                    DEUDOR: a) Pagar la totalidad de los gastos originados con
                    ocasión la prenda del vehículo y del cobro, así como los
                    impuestos de timbre, papel sellado que cause el contrato,
                    gastos de matrícula, licencia de circulación, placas,
                    registro de la prenda, etc. B) Pagar la totalidad de las
                    sumas que resulten de la imposición de multas y sanciones
                    por infracciones de policía o de tránsito, indemnizaciones a
                    terceros por daños ocasionados en el manejo del vehículo y
                    en general, la totalidad de los gastos que en una u otra
                    forma puedan derivarse del vehículo objeto de la prenda. C)
                    Permitir al ACREEDOR el derecho de inspección sobre el
                    estado del vehículo dado en prenda, para cuyo efecto
                    presentará la motocicleta en el sitio que indique EL
                    ACREEDOR, cada vez que este así lo requieran. D) Mantener en
                    perfecto estado de funcionamiento ejecutando a su costa las
                    revisiones periódicas y las reparaciones necesarias. E)
                    Informar al ACREEDOR, cualquier cambio de domicilio o
                    residencia dentro de los 10 días siguientes a la fecha en
                    que se realice. F) EL DEUDOR está obligado a gestionar lo
                    pertinente de este contrato ante la respectiva Oficina de
                    Tránsito, debiendo entregar al ACREEDOR fotocopia de la
                    Tarjeta de Propiedad en que obre la misma constancia y
                    ...
                    obligaciones la ciudad de {billData[0].CIUDAD}. Para efecto,
                    sus obligaciones y responsabilidades son las mismas de un
                ...
                <tr>
                  ...
                  >
                    Para constancia se firma en {billData[0].CIUDAD}, el día{' '}
