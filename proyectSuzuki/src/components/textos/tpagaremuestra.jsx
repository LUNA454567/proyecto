...
export default function TPagareFinaval() {
  ...
  return (
    <>
      <Grid item xs={12}>
        <Box
          sx={{ margin: '1px', padding: 0.1, border: '0px dashed grey' }}
                ...
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={2} sx={{ padding: '8px' }}>
                      PAGARE No.5891015543
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ padding: '8px' }}>
                      SUMA ADEUDADA POR CONCEPTO DE CAPITAL <br />
                    </TableCell>
                    <TableCell sx={{ padding: '8px' }}>
                      Por Valor de: ($_______________) Valor en letras:
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ padding: '8px' }}>
                      TASA DE INTERÉS REMUNERATORIA EFECTIVA ANUAL:
                    </TableCell>
                    <TableCell sx={{ padding: '8px' }}></TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ padding: '8px' }}>
                      PLAZO DE PAGO (MENSUAL): _______________________
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell colSpan={2}>
                      FECHA DE PAGO DE LA PRIMERA CUOTA: ___DE__DE 202 ___
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ padding: '8px' }}>
                      FECHA DE VENCIMIENTO FINAL: ____________________
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell sx={{ padding: '8px' }}>
                      VALOR SEGURO DE VIDA:__________________________
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell
                  ...
                  <TableRow>
                    ...
                    >
                      En el evento de prórroga u Otrosí al presente título
                      suscrito por uno cualquiera de los deudores, subsistirá la
                      solidaridad e indivisibilidad establecida entre todos los
                      suscriptores del título. En caso de prórroga, novación o
                      modificación de la obligación a mi (nuestro) cargo
                      contenida en éste título valor, manifiesto (festamos)
                      desde ahora que acepto (amos) expresamente que continúe
                      vigentes todas y cada una de las garantías que para tal
                      efecto se hayan presentado, sean reales o personales,
                      garantías que se entenderán ampliadas a las nuevas
                      obligaciones que pueden surgir conforme a lo previsto en
                      el artículo 1708 del Código Civil. En caso de acción
                      judicial me (nos) adhiero (adherimos) al nombramiento de
                      secuestre que haga el Acreedor. Si la presente obligación
                      se encuentra garantizada con prenda, yo (nosotros) nos
                      obligamos a presentar a{' '}
                  ...
                  <TableRow>
                    ...
                    >
                      ...
                      a <b></b>SUZUKI MOTOR DE COLOMBIA S.A., o a quien
                      ...
                      mi información con las filiales o vinculadas de SUZUKI
                      MOTOR DE COLOMBIA S.A. Conozco que el alcance de esta
                      autorización implica que el comportamiento frente a mis
                      obligaciones será registrado con el objeto de suministrar
                      información suficiente y adecuada al mercado sobre el
                      estado de mis obligaciones, comerciales, crediticias, de
                      servicios y la proveniente de terceros países de la misma
                      naturaleza. En consecuencia, quienes se encuentren
                      afiliados y/o tengan acceso a la Central de Información
                      –CIFIN o a cualquier otra entidad pública o privada,
                      nacional, extranjera o multilateral, que administre o
                      maneje bases de datos podrán conocer esta información, de
                      conformidad con la legislación y jurisprudencia aplicable.
                      La información podrá ser igualmente utilizada para efectos
                      estadísticos. Mis derechos y obligaciones así como la
                      permanencia de mi información en las bases de datos
                      corresponden a lo determinado por el ordenamiento jurídico
                      aplicable del cual, por ser de carácter público, estoy
                      enterado. En caso de que, en el futuro, el autorizado en
                      este documento efectúe, a favor de un tercero, una venta
                      de cartera o una cesión a cualquier título de las
                      obligaciones a mi cargo, los efectos de la presente
                      autorización se extenderán a éste en los mismos términos y
                      condiciones. Así mismo, autorizo a la Central de
                      Información a que, en su calidad de operador, ponga mi
                      información a disposición de otros operadores nacionales o
                      extranjeros, en los términos que establece la ley, siempre
                      y cuando su objeto sea similar al aquí establecido.
                      Declaro (amos) que en mi (nuestro) poder ha quedado copia
                      de este instrumento
                    </TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <td>
                      <table>
                        <TableRow>
                          <TableCell
                            sx={{ padding: '8px', marginRight: '20px' }}
                          >
                            <span style={{ marginRight: '190px' }}>
                              Nombre del deudor:
                            </span>
